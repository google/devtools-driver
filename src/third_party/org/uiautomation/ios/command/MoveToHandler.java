...
/** Handles the WebDriver /moveto command. */
public class MoveToHandler extends CommandHandler {
  public MoveToHandler(IOSServerManager driver, WebDriverLikeRequest request) {
